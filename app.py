...
def check_login():
    ...
    if not st.session_state.logged_in:
        ...
        st.markdown("## 🔐 Sistema de Inventario — Acceso restringido")
        st.markdown("---")
        ...
        if entrar:
            if (usuario == st.secrets["auth"]["usuario"] and
...
OPCIONES_UNIDAD = [
    "ADMINISTRACION","FACTURACION", "AUDITORIA", "CONSULTA EXTERNA",
    "TALENTO HUMANO", "CALIDAD", "SISTEMAS", "SST",
    "CARTERA", "CONTABILIDAD", "SIAU", "ARCHIVO", "ASISTENCIAL"
]


OPCIONES_UBICACION = [
    "ADMINISTRACION", "AUTORIZACIONES", "ALA ROJA", "ALA ROSA-VERDE", "ALA AMARILLA", "ALA AMARILLA/3ER PISO",
    "ALA AZUL","ADMISIONES", "ARCHIVO", "AUDITORIA", "CALIDAD", "CALL CENTER", "CARTERA", 
